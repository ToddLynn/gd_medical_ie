...
def evaluate(args, eval_iter, model, mode):
    ...
    if mode == "eval":
        ...
        precision, recall, f1 = get_precision_recall_f1("data/dev_data_280.json", predict_file_path)
...
def main():
    ...
    train_dataset = DuIEDataset(args,
                                ...
                                json_path="data/train_data_870.json",
                                tokenizer=tokenizer)
    eval_dataset = DuIEDataset(args,
                               # json_path="data/zhoujx/kt_dev_196.json",
                               json_path="data/dev_data_280.json",
